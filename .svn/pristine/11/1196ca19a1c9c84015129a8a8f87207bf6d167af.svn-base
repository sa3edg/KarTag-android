...
public class NotificationListAdapter<Notification> extends
		...
		if (com.kartag.persistence.model.bo.Notification.JOIN_REQUEST_TYPE
			...
			holder.accept.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					acceptTrip(model.getTripId(), model.getFromUid());
				}
			});
			holder.reject.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					setIndex(selectedIndex);
					rejectTrip(model.getTripId(), model.getFromUid());
				}
			});
			...
			{
				holder.reject.setImageDrawable(context.getResources().getDrawable(R.drawable.canceled));
			}
	...
	private void acceptTrip(String tripId, String fromUid) {
		OrderCoordinator.handleOrder(this,
				RequestFactory.createAcceptTripRequest(tripId, fromUid));
	}

	private void rejectTrip(String tripId, String fromUid) {
		OrderCoordinator.handleOrder(this,
				RequestFactory.createRejectTripRequest(tripId, fromUid));
	}
