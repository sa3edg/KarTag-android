...
public class NeedArideScreen extends AbstractScreen {
	...
	public NeedArideScreen(FragmentActivity activity) {
		super(activity);
	}
	...
	public void loadScreen() {
		...
		titleText.setText(activity.getResources().getString(R.string.needArideTitle));
		...
		final String friendsOfFriendsRequestsTitle = activity.getResources().getString(
				R.string.friendsOfFriendsOffers);
...
//				if(tHost.getCurrentTab() == 0) {
					...
					if (friendsOffersfm == null) {
				...
				else if (tabId.equalsIgnoreCase(friendsOfFriendsRequestsTitle)) {
						...
						if (friendsOfFriendsOffersfm == null) {
							...
							ft.add(R.id.realtabcontent, getFriendsOfFriendsOffersList(),
					...
					if (poolsfm == null) {
						...
						ft.add(R.id.realtabcontent, getPoolsList(),
								poolsTitle);
		...
		TabHost.TabSpec tSpecFriendsRequests = tHost.newTabSpec(friendsRequestsTitle);
//		tSpecFriendsRequests.setIndicator(friendsRequestsTitle, activity.getResources()
//				.getDrawable(R.drawable.friends_req));
		tSpecFriendsRequests.setIndicator(friendsRequestsTitle);
		tSpecFriendsRequests.setContent(new DummyTabContent(activity.getBaseContext()));
		tHost.addTab(tSpecFriendsRequests);

		TabHost.TabSpec tSpecFriendsOfFriendsRequest = tHost.newTabSpec(friendsOfFriendsRequestsTitle);
//		tSpecFriendsOfFriendsRequest.setIndicator(friendsOfFriendsRequestsTitle, activity.getResources()
//				.getDrawable(R.drawable.friends_of_friends_req));
		tSpecFriendsOfFriendsRequest.setIndicator(friendsOfFriendsRequestsTitle);
		tSpecFriendsOfFriendsRequest.setContent(new DummyTabContent(activity.getBaseContext()));
...
//		tSpecSearchRequests.setContent(new DummyTabContent(activity.getBaseContext()));
//		
//		//tSpecSearchRequests.setContent(new Intent(this.getActivity(), SearchTripsFm.class));
//		tHost.addTab(tSpecSearchRequests);
		
		ImageButton addTrip = (ImageButton) activity.findViewById(R.id.addTripBtn);
		addTrip.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.putExtra("tripType", Trip.OFFER);
		...
		ImageButton myTrips = (ImageButton) activity.findViewById(R.id.btnMyTrips);
		myTrips.setOnClickListener(new OnClickListener() {
        	 
			public void onClick(View arg0) {
				Intent intent = new Intent(activity, MainActivity.class);
				intent.putExtra(MainActivity.nextScreenParam, MainActivity.MY_TRIPS_SCREEN_ID);
				intent.putExtra("tripsType", Trip.REQUEST);
				activity.startActivity(intent);
			}
		...
		inbox.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent intent = new Intent(activity, MainActivity.class);
				intent.putExtra(MainActivity.nextScreenParam, MainActivity.INBOX_ID);
				activity.startActivity(intent);
			}
...
//		});
		...
		ImageButton feedback = (ImageButton) activity.findViewById(R.id.btnFeedback);
		feedback.setOnClickListener(new OnClickListener() {
        	 
			public void onClick(View arg0) {
				Intent intent = new Intent(activity, MainActivity.class);
				intent.putExtra(MainActivity.nextScreenParam, MainActivity.FEEDBACK_ID);
				activity.startActivity(intent);
			}
 
		});
		
		ImageButton setting = (ImageButton) activity.findViewById(R.id.btnSetting);
		setting.setOnClickListener(new OnClickListener() {
        	 
			public void onClick(View arg0) {
				Intent intent = new Intent(activity, MainActivity.class);
				intent.putExtra(MainActivity.nextScreenParam, MainActivity.SETTING_ID);
				activity.startActivity(intent);
			}
 
		});
		ImageButton back = (ImageButton) activity.findViewById(
				R.id.haveArideBackBtn);
		...
		TextView notifications = (TextView)activity.findViewById(
				R.id.notification);
		if(User.getInstance().getNotifications() > 0)
		{
			notifications.setVisibility(View.VISIBLE);
		    notifications.setText(String.valueOf(User.getInstance().getNotifications()));
		}
		...
		private void createFriendsOffersList() {
			setFriendsOffersList(new FriendsListFm(this, Trip.OFFER));
		}
		private void createFriendsOfFriendsOffersList() {
			setFriendsOfFriendsOffersList(new FriendOfFriendsTripsListFm(this, Trip.OFFER));
		}
		private void createpoolsList() {
			setPoolsList(new PoolsListFragment(this, Trip.OFFER));
		}
		private void createSearchOffersFm() {
			setSearchFragment(new SearchTripsFm(this, Trip.OFFER));
		}
		...
		private void createCommunityFragment() {
			setCommunityFragment(new CommunityTripsListFm(this, Trip.OFFER));
		}
