...
import com.kartag.gui.presentation.SearchScreen;
...
import com.kartag.util.StringUtils;
...
public class MainActivity extends FragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(StringUtils.isEmpty(User.getInstance().getCountryId())){
			User.getInstance().setCountryId(UserUtils.getCountryCode(this));
		}
		...
		case SETTING_ID:
			...
			break;
		case SEARCH_ID:
			screenToShow = new SearchScreen(this, getIntent().getStringExtra(
					"tripType"));
			break;
