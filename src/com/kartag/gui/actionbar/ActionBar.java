...
package com.kartag.gui.actionbar;
...
public class ActionBar extends RelativeLayout implements OnClickListener {
    ...
    public ActionBar(Context context, AttributeSet attrs) {
        ...
        setmActionsView((LinearLayout) mBarView.findViewById(R.id.actionbar_actions));
...
//        }
    ...
    public void addAction(Action action) {
        final int index = getmActionsView().getChildCount();
    ...
    public void addAction(Action action, int index) {
        getmActionsView().addView(inflateAction(action), index);
    }
    ...
    public void removeAllActions() {
        getmActionsView().removeAllViews();
    }
    ...
    public void removeActionAt(int index) {
        getmActionsView().removeViewAt(index);
    }
    ...
    public void removeAction(Action action) {
        int childCount = getmActionsView().getChildCount();
        for (int i = 0; i < childCount; i++) {
            View view = getmActionsView().getChildAt(i);
            if (view != null) {
                final Object tag = view.getTag();
                if (tag instanceof Action && tag.equals(action)) {
                    getmActionsView().removeView(view);
                }
            }
        }
    }
    ...
    public int getActionCount() {
        return getmActionsView().getChildCount();
    }
    ...
    private View inflateAction(Action action) {
        View view = mInflater.inflate(R.layout.actionbar_item, getmActionsView(), false);
