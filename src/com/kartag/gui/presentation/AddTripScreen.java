...
//	private boolean smokkingAllowed = false;
	...
	private CheckBox friendsOnlyBtn;
	private CheckBox womenOnlyBtn;
	private CheckBox smokkingAllowedBtn;
	...
	public void loadScreen() {
		...
		//ImageView selectDaysImage = (ImageView) activity.findViewById(R.id.daysImage);
		if ("weekly".equals(frequency)) {
			selectDaysBtn.setVisibility(View.VISIBLE);
			//selectDaysImage.setVisibility(View.VISIBLE);
		}
		...
		friendsOnlyBtn = (CheckBox) activity
				.findViewById(R.id.friendschekcbox);
		

		womenOnlyBtn = (CheckBox) activity
				.findViewById(R.id.womenchekcbox);
		
		smokkingAllowedBtn = (CheckBox) activity
				.findViewById(R.id.smokkingchekcbox);
	...
	private void addTrip() {
		...
		trip.setFriendsOnly(friendsOnlyBtn.isChecked());
		trip.setWomenOnly(womenOnlyBtn.isChecked());
		trip.setSmokingAllowed(smokkingAllowedBtn.isChecked());
		trip.setComment(comment.getText().toString());
		if(!"".equals(User.getInstance().getSetting().getCommunityId()) && !User.EMPTY_COMMUNITY.equals(User.getInstance().getSetting().getCommunityId())){
			trip.setCommunityId(User.getInstance().getSetting().getCommunityId());
		}
		addedTrip = trip;
