...
public class DateTimePickerDialog extends Dialog {
	...
	public DateTimePickerDialog(FragmentActivity activity) {
		super(activity);
	...
	public void loadScreen() {
		...
		ArrayWheelAdapter<String> ampmAdapter = new ArrayWheelAdapter<String>(
				this.getContext(), new String[] { "AM", "PM" });
		...
		day.setViewAdapter(new DayArrayAdapter(this.getContext(), calendar));

	}

	public String getTime() {
		return getAmPmHour(hours.getCurrentItem() + 1) + ":"
				+ padByZero(mins.getCurrentItem());
	}

	private String getAmPmHour(int value) {
	...
	public String getDate() {
		...
		cal.set(Calendar.DAY_OF_MONTH, dayIndex + today);
		return padByZero(cal.get(Calendar.DAY_OF_MONTH)) + "-"
				+ padByZero((cal.get(Calendar.MONTH) + 1)) + "-"
